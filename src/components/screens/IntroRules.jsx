...
export const IntroRules = () => {
    ...
    const getText = () => {
        ...
        if (part === 2) return (
            <>
                <p><Bold>Начни с планнера:</Bold> расставь карточки и настрой свой идеальный день. После этого откроются игры — <Bold>«Блендер» и челлендж недели</Bold>.{'\n'}Каждый понедельник ты узнаёшь новую тему и цели челленджей.</p>
            ...
            return (
               <>
                    ...
                    {user.isTargeted ? (
                        <>
                            <p>
                                В течение 4 недель <Bold>зарабатывай баллы в играх</Bold> для участия в розыгрыше. Призы разыгрываются каждую неделю. В конце игры проводится финальный <Bold>розыгрыш супер-приза</Bold>.
                            </p>
                            <p>
                                В еженедельных розыгрышах учитываются баллы, полученные в рамках конкретной недели. <Bold>Баллы суммируются и конвертируются в шансы — </Bold>вид баллов для участия в розыгрыше супер-приза. Шансы также можно получить за выполнение заданий.
                            </p>
                        </>
                    ): (
