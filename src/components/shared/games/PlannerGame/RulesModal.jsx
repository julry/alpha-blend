    ...
    return (
        <Modal isDarken isOpen={isOpen}>
            <Content hasCloseIcon onClose={onClose}>
                ...
                <Text>
                    Перед тобой 15 карточек с делами. Нажимай сначала на карточку, а потом на блок — утро, день и вечер. В каждую часть дня можно поставить до 3 карточек. Как только поставишь карточку, она «закрепится» и переместить её будет нельзя.
                </Text>
                <Text>
