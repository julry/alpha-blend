                        ...
                        </TitleStyled>
                        {
                           user.isTargeted ? (
                                <PointsWrapper $ratio={ratio}>
                                    <Text><Bold>Играя, ты зарабатываешь баллы</Bold> для участия в розыгрышах.{'\n'}Всего за игру мы проведём 5 розыгрышей — по одному в конце каждой недели и финальный розыгрыш суперприза в конце. </Text>
                                    <BrStyled/>
                                    <PointsSubtitle>Еженедельный розыгрыш</PointsSubtitle>
                                    <BrStyled/>
                                    <Text>Минимальное количество для участия — 700 баллов. Считаются только баллы, заработанные в рамках текущей недели. Баллы дублируются в счётчик общих баллов.</Text>
                                    <BrStyled />
                                    <Text><Bold>Среди призов:</Bold> плёночный фотоаппарат Kodak, сертификаты Ozon, Литрес, VK Музыка и многое другое.</Text>
                                    <BrStyled />
                                    <Text>Баллы можно получить за игры «Планер», «Блендер», «Челлендж недели».</Text>
                                    <BrStyled />
                                    <PointsSubtitle>Розыгрыш суперприза</PointsSubtitle>
                                    <BrStyled />
                                    <Text><Bold>Главный приз в игре</Bold> — Apple iPhone 16 Pro Max. Для участия в розыгрыше суперприза нужны шансы.</Text>
                                    <BrStyled />
                                ...
                                <>
                                    ...
                                    <UlStyled>
                                        <Li>
                                        Проходить игры «Планер», «Блендер», «Челлендж недели»
                                        </Li>
                                        <Li>
            ...
            case 2:
                return (
                    <>
                        ...
                        <Text>
                            <Bold>Распредели 12 карточек</Bold> с делами на утро, день и вечер — в каждый блок можно положить до 3. Не забудь про <Bold>челлендж недели</Bold> — зафиксировать результат можно только с ней!
                            <br />
                            <br />
            ...
            case 3:
                return (
                    <>
                        ...
                        <Text>
                            <Bold>В игре 4 недели.</Bold> Каждая из них посвящена отдельной теме — мы раскрываем секрет баланса работы и жизни и показываем разные стороны работы в Альфа-Банке. Вместе с новой темой появляется новая мини-игра.
                        </Text>
                    </>
                )
            case 4:
